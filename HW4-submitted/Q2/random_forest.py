...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        # _, count = np.unique(bootstrapping_mask, return_counts=True)
        # print('bootstrapping_mask', bootstrapping_mask, _, count)
    ...
    def voting(self, X):
        ...
        for record in X:
            ...
            if len(counts) == 0:
                ...
                # FIX: Use the classify result of the first (arbitrary) tree
